 ...
 * 
 * Matches the login page design with luxury glassmorphic style.
      ...
      <main className="relative z-10 flex-1 flex flex-col justify-end px-6 pb-12">
        ...
        <div className="mb-12">
          <div className="badge-pill mb-6 bg-white/10 border-white/15 text-slate-100">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-200">Create Account</span>
          </div>
          ...
          <p className="section-copy text-slate-300">
            Start tracking your finances and build better financial habits.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p style={{ fontFamily: 'Geist, system-ui, sans-serif', fontSize: '12px', color: 'rgba(255,255,255,0.3)' }}>
