...
<html lang="en">
  ...
  <body
    style="margin:0;padding:0;background:#f1f5f9;font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;font-size:15px;line-height:1.6;color:#334155;-webkit-font-smoothing:antialiased;">
      ...
      <tr>
        <td align="center" style="padding:20px 12px;">
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              <td
                style="background:#ffffff;border:1px solid #f1f5f9;border-top:none;border-radius:0 0 24px 24px;padding:24px 24px 24px;
            ...
            <tr>
              <td align="center" style="padding:16px 12px 0;font-size:12px;color:#94a3b8;line-height:1.7;">
                <p
                  style="font-weight:900;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#94a3b8;margin:0 0 6px;">
                  Pasona &middot; Know your naira
                </p>
                <p style="margin:0;">
                  You're getting this because you have an account at pasona.adebayosystems.com.ng.<br>
                  <a href="{{ $settingsUrl ?? '#' }}" style="color:#64748b;text-decoration:underline;">Notification
                    settings</a>
                  &nbsp;&middot;&nbsp;
