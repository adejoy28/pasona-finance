...
@section('content')
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fff1f2;border:1px solid #ffe4e6;border-radius:16px;margin:28px 0 0;">
        <tr>
            <td style="padding:18px 22px;">
                <p style="font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:0.18em;color:#e11d48;margin:0 0 6px;">Didn't request this?</p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#eef2ff;border:1px solid #e0e7ff;border-radius:18px;margin:0 0 28px;">
        <tr>
            <td style="padding:22px 24px;">
                <p style="font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:0.2em;color:#4f46e5;margin:0 0 14px;">A quick reminder</p>

                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td valign="top" style="width:40px;padding:0 14px 14px 0;">
                            <div style="width:28px;height:28px;border-radius:9999px;background:#2563eb;color:#ffffff;font-size:14px;line-height:28px;text-align:center;">&#x1F511;</div>
                        </td>
                        <td valign="top" style="padding:0 0 14px 0;font-size:14px;line-height:1.55;color:#334155;">Pasona will <strong style="color:#0f172a;">never</strong> ask for your password in an email or DM.</td>
                    </tr>
                    <tr>
                        <td valign="top" style="width:40px;padding:0 14px 14px 0;">
                            <div style="width:28px;height:28px;border-radius:9999px;background:#059669;color:#ffffff;font-size:14px;line-height:28px;text-align:center;">&#x2705;</div>
                        </td>
                        <td valign="top" style="padding:0 0 14px 0;font-size:14px;line-height:1.55;color:#334155;">Use a password manager — your future self will thank you.</td>
                    </tr>
                    <tr>
                        <td valign="top" style="width:40px;padding:0 14px 0 0;">
                            <div style="width:28px;height:28px;border-radius:9999px;background:#d97706;color:#ffffff;font-size:14px;line-height:28px;text-align:center;">&#x26A0;&#xFE0F;</div>
                        </td>
                        <td valign="top" style="padding:0;font-size:14px;line-height:1.55;color:#334155;">Public Wi-Fi + password resets = bad combo. Wait till you're home.</td>
                    </tr>
                </table>
            </td>
        </tr>
